  ...
  return (
    <section className={"relative w-full h-[90vh] xs:h-screen mx-auto"}>
      ...
      <div
        ...
        className={cn(
          `m-auto  md:pr-4 w-full sm:w-full h-full cursor-grab pt-20 sm:pt-0`,
          isGrabbing && "cursor-grabbing"
        )}
      >
        <ComputersCanvas />
      </div>
      <div className="absolute xs:bottom-20 md:bottom-6 bottom-16 w-full flex justify-center items-center">
        <a href="#about">
